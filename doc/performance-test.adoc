...
`ramp.py` was written to simplify performance testing over different number of connections, payload sizes, and number of requests.  It ramps one variable, run the performance test multiple times, and reports averages.
